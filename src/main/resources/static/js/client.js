function traerInformacionClient(){
    $.ajax(
              {
                url:"http://143.47.124.121:81/api/Client/all",
                type:"GET",
                datatype:"JSON",
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Client/save',
            type         : 'POST',
            data         :  dataToSendC,
            datatype     :  "JSON",
    ...
    $.ajax (
                {
                    ...
                    url          : 'http://143.47.124.121:81/api/Client/update',
                    type         : 'PUT',
                    data         :  dataToSend,
                    datatype     :  "JSON",
                    contentType  : 'application/json',                    
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Client/' + idElemento,
            type         : 'DELETE',
            data         :  dataToSend,
            contentType  : 'application/json',
            datatype     :  "JSON",
