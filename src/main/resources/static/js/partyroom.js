function traerInformacionPartyroom(){
    $.ajax(
              {
                url:"http://143.47.124.121:81/api/Partyroom/all",
                type:"GET",
                datatype:"JSON",
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Partyroom/save',
            type         : 'POST',
            data         :  dataToSend,
            datatype     :  "JSON",
    ...
    $.ajax (
                {
                    ...
                    url          : 'http://143.47.124.121:81/api/Partyroom/update',
                    type         : 'PUT',
                    data         :  dataToSend,
                    datatype     :  "JSON",
                    contentType  : 'application/json',                    
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Partyroom/' + idElemento,
            type         : 'DELETE',
            data         :  dataToSend,
            contentType  : 'application/json',
            datatype     :  "JSON",
