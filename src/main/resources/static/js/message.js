function traerInformacionMessage(){
    $.ajax(
              {
                url:"http://143.47.124.121:81/api/Message/all",
                type:"GET",
                datatype:"JSON",
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Message/save',
            type         : 'POST',
            data         :  dataToSendM,
            datatype     :  "JSON",
    ...
    $.ajax (
                {
                    ...
                    url          : 'http://143.47.124.121:81/api/Message/update',
                    type         : 'PUT',
                    data         :  dataToSendM,
                    datatype     :  "JSON",
                    contentType  : 'application/json',                    
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Message/' + idElemento,
            type         : 'DELETE',
            data         :  dataToSendM,
            contentType  : 'application/json',
            datatype     :  "JSON",
