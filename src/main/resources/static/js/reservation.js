function traerInformacionReservation(){
    $.ajax(
              {
                url:"http://143.47.124.121:81/api/Reservation/all",
                type:"GET",
                datatype:"JSON",
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Reservation/save',
            type         : 'POST',
            data         :  dataToSendM,
            datatype     :  "JSON",
    ...
    $.ajax (
                {
                    ...
                    url          : 'http://143.47.124.121:81/api/Reservation/update',
                    type         : 'PUT',
                    data         :  dataToSend,
                    datatype     :  "JSON",
                    contentType  : 'application/json',                    
    ...
    $.ajax (
        {
            ...
            url          : 'http://143.47.124.121:81/api/Reservation/' + idElemento,
            type         : 'DELETE',
            data         :  dataToSend,
            contentType  : 'application/json',
            datatype     :  "JSON",
...
function consultarTopClientes() {
    $.ajax(
        {
        url:'http://143.47.124.121:81/api/Reservation/report-status',
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
